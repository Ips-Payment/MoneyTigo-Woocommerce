...
class WC_MoneyTigoPnf extends WC_Payment_Gateway
{
	...
	*/
	public function __construct()
	{
		...
		$this->moneytigopnf_gateway_api_uri = "https://wws.ips-payment.com";
		$this->moneytigopnf_gateway_minimum_p3f = $this->settings['moneytigopnf_gateway_minimum_p3f'];
		$this->moneytigopnf_gateway_get_transaction_uri = "https://wws.ips-payment.com/transactions/";
		$this->moneytigopnf_gateway_library_uri = "https://wws.ips-payment.com/6598874bb8d7bfdb56df4b5d6f4b56d/js/IPSSDK-Cms.js";
		$this->moneytigopnf_gateway_create_transaction_uri = "https://wws.ips-payment.com/init_transactions/";
...
public function generate_Payment_Form( $MoneyTigoParameters ) {
  ...
  wp_enqueue_script( 'wc_MoneyTigo', ''.$this->moneytigopnf_gateway_library_uri.'', array( 'jquery' ), '1.0.0', true );
