...
function moneytigo_in_footer() {
  echo '<hr><center><a href="https://www.moneytigo.com"><img src="' . plugin_dir_url( __FILE__ ) . 'assets/img/footer_moneytigo_logo.png" style="margin-bottom: 5px;" alt="' . __( 'Secure payment by MoneyTigo ™', 'moneytigo_woocommerce' ) . '" title="' . __( 'Secure payment by MoneyTigo ™', 'moneytigo_woocommerce' ) . '"></a></center>';
}
